...
# RDN BI model (x2)
#python3.6 main.py --scale 2 --save RDN_D16C8G64_BIx2 --model RDN --epochs 200 --batch_size 16 
#--data_range 801-805 --patch_size 64 --reset
# RDN BI model (x3)
...
# python main.py --model HAN --scale 2 --patch_size 32 --save han_baseline_x2
#python main.py --model PSMYCSB --patch_size 192 --scale 3 --save psmysmall_csb_3x --n_feats 48 --save_models
#python main.py --model PSMYCSB --patch_size 256 --scale 4 --save psmysmall_csb_4x --n_feats 48 --save_models

#python main.py --model UPSRB --patch_size 192 --n_feats 48 --scale 3 --save ablation/cmycsb_3x --save_models
python main.py --model mfpne --scale 2 --patch_size 96 --save mfpne --n_threads 4 --data_test DIV2K --batch_size 16 --n_feats 48 --reset
